...
"2. There are 2 types of actions each player can do in each turn"
...
"Cost of action is below: {'build':{'energy':-5},'nuclear':{'science':-5},'research':{'science':-5}}";
    ...
    "The other players:"
    "Player2 is Gandhi. In his previous games, he used nuclear weapon 26 times out of 3 games.\n"
    "Player3 is Vitalik. He never use nuclear weapon.\n";
...
//     civAIAgent2 = new CivAIAgent(initialOracleAddress, initPrompt, agent2StrategyPrompt, opponentsPrompt);
...
//     civAIAgent3 = new CivAIAgent(initialOracleAddress, initPrompt, agent3StrategyPrompt, opponentsPrompt);


//     string memory agent4StrategyPrompt = 
//     "You should focus on gathering the most resources";
//     civAIAgent4 = new CivAIAgent(initialOracleAddress, initPrompt, agent3StrategyPrompt, opponentsPrompt);
