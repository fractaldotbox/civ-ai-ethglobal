...
contract CivAIAgent {
    ...
    constructor(
        ...
        // avoid buffer overrun while deserializing, do not concat
        prompt = basePrompt;
    ...
    // TODO kb
    function updateStrategy(string memory strategyPrompt)  public onlyOwner {
        AgentRun storage run = agentRuns[agentRunCount];

        Message memory systemMessage;
        systemMessage.content = strategyPrompt;
