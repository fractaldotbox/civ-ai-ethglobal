...
const deriveTileBgColor = (tile: Tile) => {
...
const LABEL_BY_WEATHER_STATION = {
...
} as Record<TileWeatherStation, any>
            ...
            <div
                ...
                <div className="flex flex-col">
                    <div className="text-xl">
                        {LABEL_BY_WEATHER_STATION[weatherStation as TileWeatherStation]}
                    </div>
                </div>
            </div>
        )
